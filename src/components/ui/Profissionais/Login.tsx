...
const LoginBarbeiros = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const nomes = sessionStorage.getItem("nome")
      ...
      setTimeout(() => {
        permissao === "admin" ? navigate("/Barbeiros") : navigate("/LoginBarbeiros");
      }, 3650)
      ...
      setErro("Erro ao fazer login. Verifique as credenciais.");
    }
  };
